...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(ADDR_PIN_0_PORT, ADDR_PIN_0_PIN)) : (DL_GPIO_clearPins(ADDR_PIN_0_PORT, ADDR_PIN_0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(ADDR_PIN_1_PORT, ADDR_PIN_1_PIN)) : (DL_GPIO_clearPins(ADDR_PIN_1_PORT, ADDR_PIN_1_PIN)))// 地址位0控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(ADDR_PIN_2_PORT, ADDR_PIN_2_PIN)) : (DL_GPIO_clearPins(ADDR_PIN_2_PORT, ADDR_PIN_2_PIN)))// 地址位0控制
